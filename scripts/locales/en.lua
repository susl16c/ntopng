local lang = {
  ...
  ["alert_messages"] = {
    ...
    ["alert_port_too_many_macs"] = "Too many MACs on non-trunk <a href=\"%{url}\">%{ip}</a> interface <a href=\"%{port_url}\">%{port}</a> [%{value} %{op} %{threshold} MACs]",
    ...
    ["suspicious_dga_domain"] = "Suspicious DGA Domain %{href} [ %{domain} %{info}]",
  ...
  ["alerts_dashboard"] = {
    ...
    ["alert_port_too_many_macs_title"] = "Too Many MACs on Non-Trunk",
    ...
    ["binary_application_transfer_url"] = "%{type_icon} Detected binary application transfer %{href} [%{url} %{info}]",
  ...
  ["details"] = {
    ...
    ["peers"] = "Peers: Active",
    ["probes_ipv4_address"] = "Last Probe IPv4 Address",
    ["rcvd"] = "Rcvd",
  ...
  ["flow_risk"] = {
    ...
    ["ndpi_tls_suspicious_extension"] = "TLS Suspicious Extension",
  ...
  ["prefs"] = {
    ...
    ["data_retention_descr"] = "Number of days to keep dumped flows, alerts, historical timeseries and top-talkers for. Default: 30 days.",
    ...
    ["teams_send_error"] = "Error sending message to the Microsoft Teams.",
    ["teams_sent_successfully"] = "A message has been sent to the Microsoft Teams",
    ["telemetry"] = "Telemetry",
