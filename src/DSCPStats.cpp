...
const u_int8_t ds_table[NUM_DS_VALUES] = {
    /* [0] = */ 0,           /* [1] = */ DS_PR_LE,
    /* [2] = */ DS_PR_UNKN,  /* [3] = */ DS_PR_UNKN,
    /* [4] = */ DS_PR_UNKN,  /* [5] = */ DS_PR_UNKN,
    /* [6] = */ DS_PR_UNKN,  /* [7] = */ DS_PR_UNKN,
    /* [8] = */ 1,           /* [9] = */ DS_PR_UNKN,
    /* [10] = */ 1,          /* [11] = */ DS_PR_UNKN,
    /* [12] = */ 1,          /* [13] = */ DS_PR_UNKN,
    /* [14] = */ 1,          /* [15] = */ DS_PR_UNKN,
    ...
    /* [38] = */ 4,          /* [39] = */ DS_PR_UNKN,
    /* [40] = */ 5,          /* [41] = */ DS_PR_UNKN,
    /* [42] = */ DS_PR_UNKN, /* [43] = */ DS_PR_UNKN,
    /* [44] = */ DS_PR_UNKN, /* [45] = */ DS_PR_UNKN,
    /* [46] = */ 5,          /* [47] = */ DS_PR_UNKN,
    /* [48] = */ 6,          /* [49] = */ DS_PR_UNKN,
    /* [50] = */ DS_PR_UNKN, /* [51] = */ DS_PR_UNKN,
    /* [52] = */ DS_PR_UNKN, /* [53] = */ DS_PR_UNKN,
    /* [54] = */ DS_PR_UNKN, /* [55] = */ DS_PR_UNKN,
    /* [56] = */ DS_PR_UNKN,
    /* [57] = */ 7,          /* [58] = */ DS_PR_UNKN,
    /* [59] = */ DS_PR_UNKN, /* [60] = */ DS_PR_UNKN,
    /* [61] = */ DS_PR_UNKN, /* [62] = */ DS_PR_UNKN,
    /* [63] = */ DS_PR_UNKN};
  ...
  for (u_int8_t i = 0; i < DS_PRECEDENCE_GROUPS; i++) {
    if (counters[i].bytes.sent || counters[i].bytes.rcvd) {
      if (!tsLua) {
        ...
        lua_push_str_table_entry(vm, precedence2Name(i, name, sizeof(name)),
                                 buf);
      }
    }
  }
...
void DSCPStats::incStats(u_int16_t ds_id, u_int64_t sent_packets,
...
void DSCPStats::resetStats() { memset(counters, 0, sizeof(counters)); }
