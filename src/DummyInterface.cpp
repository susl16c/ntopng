...
void DummyInterface::forgeFlow(u_int iteration) {
  ...
  u_int id, mval = (ntop->getPrefs()->get_max_num_flows() / 2) /
  ...
  for (u_int i = 0; i < mval; i++) {
    ...
    snprintf(payload, sizeof(payload),
             "{\"8\":\"%s\",\"12\":\"%s\",\"10\":0,\"14\":0,\"2\":%u,\"1\":%u,"
             "\"22\":%lu,\"21\":%lu,\"7\":%u,\"11\":%u,\"6\":0,\"4\":17,\"5\":"
             "0,\"16\":0,\"17\":0,\"9\":0,\"13\":0,\"42\":297}",
  ...
  if (id == 0)
    sleep(ntop->getPrefs()->get_housekeeping_frequency());
}
