...
#define CONST_RUNTIME_IDLE_LOCAL_HOSTS_CACHE_ENABLED                           \
  NTOPNG_PREFS_PREFIX ".is_local_host_cache_enabled"
...
#define SCORE_MAX_VALUE                                                        \
  SCORE_LEVEL_SEVERE /* Maximum client/server score. Flow score is 2 *         \
                        SCORE_MAX_VALUE. */
