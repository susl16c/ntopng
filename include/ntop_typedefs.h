...
typedef enum {
  ...
  flow_alert_suspicious_tcp_syn_probing =
      18,                                /* No longer used, can be recycled */
  flow_alert_tcp_connection_issues = 19, /* No longer used, can be recycled */
  flow_alert_tcp_connection_refused = 20,
  flow_alert_tcp_severe_connection_issues =
      21, /* No longer used, merged with flow_alert_tcp_connection_issues */
  ...
  flow_alert_known_proto_on_non_std_port =
      30, /* TODO rename to alert_ndpi_known_protocol_on_non_standard_port */
  flow_alert_flow_risk =
      31, /* No longer used, each risk is reported individually */
